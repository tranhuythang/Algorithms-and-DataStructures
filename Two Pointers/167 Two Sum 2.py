...
This problem can be solved by using HashMap with O(n) time, O(n) space and not using the array being sorted, but here
the requirement is using Two Pointers to solve this problem with O(n) time, O(1) space.
